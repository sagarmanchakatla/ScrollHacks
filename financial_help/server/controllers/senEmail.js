...
exports.sendEmail = async (req, res) => {
  ...
  if (!to || !subject || !proposalContent) {
    return res
      .status(400)
      .json({ message: "To, subject, and proposal content are required." });
  }

  const transporter = nodemailer.createTransport({
    service: "gmail", // Use your email service
    auth: {
      user: "zoyah768@gmail.com", // Your email
      pass: "ksha odyf dfyw eptm", // Your email password
    },
  });
